...
- 🛡️ **Pre-Delivery Sentry Validation (Phase 13)** — Sentry setup per framework, real testing, crash reporting, deployment verdict
...
├── 13-pre-delivery-sentry-validation.md  ← Phase 13: Sentry + real testing
